...
trait SearchTemplateImplicits {
  ...
  implicit object TemplateSearchExecutable
    ...
    override def execute[F[_]: AsyncExecutor](client: HttpRequestClient, req: TemplateSearchDefinition): F[HttpResponse] = {
  ...
  implicit object RemoveSearchTemplateExecutable
    ...
    override def execute[F[_]: AsyncExecutor](client: HttpRequestClient, req: RemoveSearchTemplateDefinition): F[HttpResponse] = {
  ...
  implicit object PutSearchTemplateExecutable
    ...
    override def execute[F[_]: AsyncExecutor](client: HttpRequestClient, req: PutSearchTemplateDefinition): F[HttpResponse] = {
      val endpoint = "/_scripts/" + req.name
  ...
  implicit object GetSearchTemplateExecutable
    ...
    override def execute[F[_]: AsyncExecutor](client: HttpRequestClient, req: GetSearchTemplateDefinition): F[HttpResponse] = {
      val endpoint = "/_scripts/" + req.name
