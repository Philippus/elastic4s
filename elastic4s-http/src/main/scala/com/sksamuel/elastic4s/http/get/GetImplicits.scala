...
trait GetImplicits {
  ...
  implicit object MultiGetHttpExecutable extends HttpExecutable[MultiGetDefinition, MultiGetResponse] with Logging {
    ...
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: MultiGetDefinition): F[HttpResponse] = {
  ...
  implicit object GetHttpExecutable extends HttpExecutable[GetDefinition, GetResponse] with Logging {
    ...
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: GetDefinition): F[HttpResponse] = {
