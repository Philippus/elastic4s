...
trait CatImplicits {
  ...
  implicit object CatSegmentsExecutable extends HttpExecutable[CatSegments, Seq[CatSegmentsResponse]] {
    override def execute[F[_]: FromListener : Functor](client: HttpRequestClient, request: CatSegments): F[HttpResponse] = {
  ...
  implicit object CatShardsExecutable extends HttpExecutable[CatShards, Seq[CatShardsResponse]] {
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: CatShards): F[HttpResponse] = {
  ...
  implicit object CatNodesExecutable extends HttpExecutable[CatNodes, Seq[CatNodesResponse]] {
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: CatNodes): F[HttpResponse] = {
      val headers = Seq(
  ...
  implicit object CatPluginsExecutable extends HttpExecutable[CatPlugins, Seq[CatPluginResponse]] {
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: CatPlugins): F[HttpResponse] = {
  ...
  implicit object CatThreadPoolExecutable extends HttpExecutable[CatThreadPool, Seq[CatThreadPoolResponse]] {
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: CatThreadPool): F[HttpResponse] = {
  ...
  implicit object CatHealthExecutable extends HttpExecutable[CatHealth, CatHealthResponse] {
    ...
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: CatHealth): F[HttpResponse] = {
  ...
  implicit object CatCountExecutable extends HttpExecutable[CatCount, CatCountResponse] {
    ...
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: CatCount): F[HttpResponse] = {
  ...
  implicit object CatMasterExecutable extends HttpExecutable[CatMaster, CatMasterResponse] {
    ...
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: CatMaster): F[HttpResponse] = {
  ...
  implicit object CatAliasesExecutable extends HttpExecutable[CatAliases, Seq[CatAliasResponse]] {
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: CatAliases): F[HttpResponse] = {
  ...
  implicit object CatIndexesExecutable extends HttpExecutable[CatIndexes, Seq[CatIndicesResponse]] {
    ...
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: CatIndexes): F[HttpResponse] = {
  ...
  implicit object CatAllocationExecutable extends HttpExecutable[CatAllocation, Seq[CatAllocationResponse]] {
    ...
    override def execute[F[_]: FromListener: Functor](client: HttpRequestClient, request: CatAllocation): F[HttpResponse] = {
