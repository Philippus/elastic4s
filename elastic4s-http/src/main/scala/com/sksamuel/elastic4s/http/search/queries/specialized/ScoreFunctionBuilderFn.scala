...
import com.sksamuel.elastic4s.searches.queries.funcscorer.{FieldValueFactorDefinition, GaussianDecayScoreDefinition, RandomScoreFunctionDefinition, ScoreFunctionDefinition, ScriptScoreDefinition}
