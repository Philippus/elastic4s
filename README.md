...
The latest release is 1.6.0 which is compatible with Elasticsearch 1.6.x. There are releases for both Scala 2.10 and Scala 2.11. For releases that are compatible with earlier versions of Elasticsearch,
...
```groovy
compile 'com.sksamuel.elastic4s:elastic4s-core_2.11:1.6.0'
```
