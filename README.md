...
The latest release is 1.3.0.0 which is compatible with Elasticsearch 1.3.0. There are releases for both Scala 2.10 and Scala 2.11.
...
val client = ElasticClient.remote(settings.build(), ("somehost", 9300))
```
