...
| [Add Alias](guide/aliases.md)             | 1.4+ `aliases add "<alias>" on "<index>"` |
|                                           | 1.3- `add aliases "<alias>" on "<index>"` |
| [Remove Alias](guide/aliases.md)          | 1.4+ `aliases remove "<alias>" on "<index>"` |
|                                           | 1.3- `remove aliases "<alias>" on "<index>"` |
