...
![Current Version](https://img.shields.io/badge/version-9.3.0-brightgreen.svg?style=flat "9.3.0")
...
Current Elastic4s versions support Scala 2.13 and 3. Scala 2.10 support has been dropped starting with 5.0.x, Scala 2.11 has been dropped starting with 7.2.0 and Scala 2.12 has been dropped starting with 9.0.0. For releases that are compatible with earlier versions of Elasticsearch,
