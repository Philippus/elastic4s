...
The latest release is 2.2.1 which is compatible with Elasticsearch 2.2.x. There are releases for both Scala 2.10 and Scala 2.11. For releases that are compatible with earlier versions of Elasticsearch,
