...
The latest release is 2.3.0 which is compatible with Elasticsearch 2.3.x. There are releases for both Scala 2.10 and Scala 2.11. For releases that are compatible with earlier versions of Elasticsearch,
