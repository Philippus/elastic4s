...
lazy val tests = (project in file("elastic4s-tests"))
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "org.apache.logging.log4j"      % "log4j-api"            % "2.25.4"       % Test,
      "org.apache.logging.log4j"      % "log4j-slf4j-impl"     % "2.25.4"       % Test,
      "org.apache.logging.log4j"      % "log4j-core"           % "2.25.4"       % Test
    ),
    Test / fork               := false,
    Test / parallelExecution  := false,
