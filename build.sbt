...
libraryDependencies ++= Seq(
  ...
  "com.fasterxml.jackson.core"     %  "jackson-core"                % "2.4.0-rc2"  ,
  "com.fasterxml.jackson.core"     %  "jackson-databind"            % "2.4.0-rc2"  ,
  "com.fasterxml.jackson.module"   %% "jackson-module-scala"        % "2.4.0-rc1"  exclude ("org" +
