...
libraryDependencies ++= Seq(
  ...
  "com.fasterxml.jackson.core"     %  "jackson-databind"            % "2.4.3"  % "optional" ,
  "com.fasterxml.jackson.module"   %% "jackson-module-scala"        % "2.4.3"  % "optional"  exclude ("org.scalatest", "scalatest_2.10.0"),
