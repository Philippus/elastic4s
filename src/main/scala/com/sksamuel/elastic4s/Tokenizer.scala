...
object Tokenizer {
  ...
  case class StandardTokenizer(name: String, maxTokenLength: Int = 255) extends Tokenizer

  case class PatternTokenizer(pattern: String = "\\W+", flags: String = "", group: Int = -1) extends Tokenizer

  case class KeywordTokenizer(name: String, bufferSize: Int = 256) extends Tokenizer
