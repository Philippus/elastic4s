...
/**
  * A Pekko [[org.apache.pekko.stream.scaladsl.Source]], that publishes documents using an elasticsearch
  ...
  */
class ElasticSource(client: ElasticClient[Future], settings: SourceSettings)
