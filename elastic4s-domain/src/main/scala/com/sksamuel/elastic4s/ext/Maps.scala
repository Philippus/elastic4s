...
object Maps {
  ...
  /** Given a nested map of strings, will create a flatted map, where the strings are joined with a separator. So given
    * Map("a" -> "b", "c" -> Map("d" -> "e")) then the output will be Map("a" -> "b", "c.d" -> "e")
    */
  ...
  /** Given a java.util.Map[k, AnyRef], this method will return a scala.collection.immutable.Map[k, AnyRef] where each
    * value has been transformed such that:
  ...
  /** Given a scala.collection.immutable.Map[k, AnyRef], this method will return a java.util.Map[k, AnyRef] where each
    * value has been transformed such that:
