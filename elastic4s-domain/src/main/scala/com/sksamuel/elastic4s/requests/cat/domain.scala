...
case class CatAllocationResponse(
    shards: Int,
...
case class CatThreadPoolResponse(
    id: String,
    name: String,
    active: Int,
    rejected: Int,
