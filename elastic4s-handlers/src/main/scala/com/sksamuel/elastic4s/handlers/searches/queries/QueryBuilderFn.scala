...
import com.sksamuel.elastic4s.requests.searches.queries.matches.{MatchAllQuery, MatchNoneQuery, MultiMatchQuery}
import com.sksamuel.elastic4s.requests.searches.queries.{BoostingQuery, ConstantScore, DisMaxQuery, DistanceFeatureQuery, ExistsQuery, FuzzyQuery, IdQuery, IntervalsQuery, NoopQuery, ParentIdQuery, PercolateQuery, PinnedQuery, PrefixQuery, Query, QueryStringQuery, RankFeatureQuery, RegexQuery, ScriptQuery, SimpleStringQuery, TypeQuery}
