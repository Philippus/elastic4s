...
//    val req = linearScore("myfield", "1 2", "2km").offset("200m").decay(0.1).weight(0.1).multiValueMode(MultiValueMode.Min).filter(MatchAllQuery())
//    val builder = FunctionSc(req)
...
//    val req = gaussianScore("myfield", "1 2", "3km").offset("1km").decay(0.2).weight(0.2).multiValueMode(MultiValueMode.Min).filter(MatchAllQuery())
...
//    val req = exponentialScore("myfield", "1 2", "4km").offset("100m").decay(0.4).weight(0.3).multiValueMode(MultiValueMode.Min).filter(MatchAllQuery())
//    val builder = FilterFunctionBuilderFn(req)
//    val actual = builder.toXContent(XContentFactory.jsonBuilder(), ToXContent.EMPTY_PARAMS).string()
...
//    val req = randomScore(12345).filter(MatchAllQuery())
//    val builder = FilterFunctionBuilderFn(req)
//    val actual = builder.toXContent(XContentFactory.jsonBuilder(), ToXContent.EMPTY_PARAMS).string()
...
//    }.weight(0.4).filter(MatchAllQuery())
//    val builder = FilterFunctionBuilderFn(req)
//    val actual = builder.toXContent(XContentFactory.jsonBuilder(), ToXContent.EMPTY_PARAMS).string()
...
//    val req = weightScore(1.5).filter(MatchAllQuery())
//    val builder = FilterFunctionBuilderFn(req)
//    val actual = builder.toXContent(XContentFactory.jsonBuilder(), ToXContent.EMPTY_PARAMS).string()
...
//    val req = fieldFactorScore("likes").factor(1.2).modifier(FieldValueFactorFunctionModifier.SQRT).missing(1.0).filter(MatchAllQuery())
//    val builder = FilterFunctionBuilderFn(req)
//    val actual = builder.toXContent(XContentFactory.jsonBuilder(), ToXContent.EMPTY_PARAMS).string()
