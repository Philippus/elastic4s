...
class TextFieldTest extends AnyFlatSpec with Matchers with ElasticApi {
  ...
  "text field def" should "support text properties" in {
    ...
    val jsonStringValue =
      """{"type":"text","analyzer":"bengali","boost":1.2,"copy_to":["q","er"],"index":true,"norms":true,"store":true,"fielddata":true,"position_increment_gap":3,"index_options":"freqs","search_analyzer":"norwegian","search_quote_analyzer":"english","similarity":"Classic1"}"""
