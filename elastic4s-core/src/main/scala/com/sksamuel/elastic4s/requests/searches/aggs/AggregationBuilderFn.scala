...
object SubAggsBuilderFn {
  def apply(agg: Aggregation, builder: XContentBuilder, customAggregations: PartialFunction[AbstractAggregation, XContentBuilder]): Unit =
