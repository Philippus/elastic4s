...
import com.sksamuel.elastic4s.searches.queries.{MultiTermQuery, Query}
import com.sksamuel.exts.OptionImplicits._

trait SpanQuery extends Query

case class SpanMultiTermQuery(query: MultiTermQuery,
...
case class SpanFirstQuery(query: SpanQuery,
                          end: Int,
                          boost: Option[Double] = None,
                          queryName: Option[String] = None)
    extends Query {
